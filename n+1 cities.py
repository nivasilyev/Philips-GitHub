...
for city in cities:
    ...
    cityURL = "https://www.google.com/search?q=10+tallest+buildings+in+" + currentCity
    webbrowser.open_new_tab(cityURL)
    currentCity = formatCity(city,2)
    cityURL = "https://www.google.com/search?q=events+in+" + currentCity
    webbrowser.open_new_tab(cityURL)
...
newCityFile = open('E:\Programming\globeProject.txt', 'a')
